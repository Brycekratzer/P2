...
public class NFATest {
	...
	@Test
	public void testGetToState_ValidTransitions() {
		NFA nfa = nfa1();

		assertEquals(Set.of(nfa.getState("a")), nfa.getToState(nfa.getState("a"), '0')); // a -0-> {a}
		assertEquals(Set.of(nfa.getState("b")), nfa.getToState(nfa.getState("a"), '1')); // a -1-> {b}

		assertEquals(Set.of(nfa.getState("a")), nfa.getToState(nfa.getState("b"), 'e')); // b -ε-> {a}

		System.out.println("testGetToState_ValidTransitions done");
	}

	@Test
	public void testGetToState_NoTransitions() {
		NFA nfa = nfa1();

		assertEquals(Set.of(), nfa.getToState(nfa.getState("a"), '2')); // a -2-> ∅ (no transition)
		assertEquals(Set.of(), nfa.getToState(nfa.getState("b"), '1')); // b -1-> ∅ (no transition)

		System.out.println("testGetToState_NoTransitions done");
	}

	@Test
	public void testGetToState_InvalidState() {
		NFA nfa = nfa1();

		assertEquals(Set.of(), nfa.getToState(nfa.getState("c"), '0')); // c doesn't exist
		assertEquals(Set.of(), nfa.getToState(nfa.getState("d"), 'e')); // d doesn't exist

		System.out.println("testGetToState_InvalidState done");
	}

	@Test
	public void testGetToState_MultipleTransitions() {
		NFA nfa = nfa2();

		assertEquals(Set.of(nfa.getState("q0"), nfa.getState("q1")), nfa.getToState(nfa.getState("q0"), '1'));

		assertEquals(Set.of(nfa.getState("q2"), nfa.getState("q3")), nfa.getToState(nfa.getState("q2"), '1'));

		System.out.println("testGetToState_MultipleTransitions done");
	}
